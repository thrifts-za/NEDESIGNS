...
export default function VimeoPlayer({ url, className = '', backgroundMode = true }: VimeoPlayerProps) {
  ...
  const embedUrl = backgroundMode
    ? `https://player.vimeo.com/video/${videoId}?background=1&autoplay=1&loop=1&muted=1&autopause=0&controls=${isHovered ? '1' : '0'}&dnt=1`
    : `https://player.vimeo.com/video/${videoId}?autoplay=1&autopause=0&dnt=1`;
